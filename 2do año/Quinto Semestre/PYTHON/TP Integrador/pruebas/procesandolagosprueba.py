...
def calculateSeconds(coords: str): #EJEMPLO: "40°19'60""S" (buscando 60)
    ...
    direction = seconds[-1] # El ultimo dijo es la direccion asi que la guarda: (S)
...
def coordinates(coords: str):
    GD = str(calculateGrades(coords) + calculateMinutes(coords) / 60 + calculateSeconds(coords) / 3600)
    return GD
