...
def calculate_minutes(coords: str): #EJEMPLO: "40°19'60""S" (buscando 19)
...
def calculate_seconds(coords: str): #EJEMPLO: "40°19'60""S" (buscando 60)
...
def calculate_grades(coords: str): #EJEMPLO: "40°19'60""S" (buscando 40)
